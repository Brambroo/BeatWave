...
public class MainMenuWaveGenerator2 : MonoBehaviour
{
    ...
    public MainMenuWaveGenerator2[] children;
    ...
    public void Start()
    {
        if (this.gameObject.name == "Plane_1")
        {
            children = new MainMenuWaveGenerator2[] { GameObject.Find("Plane5").GetComponentInChildren<MainMenuWaveGenerator2>(), GameObject.Find("Plane6").GetComponentInChildren<MainMenuWaveGenerator2>(),
            GameObject.Find("Plane7").GetComponentInChildren<MainMenuWaveGenerator2>()};
        }
        else
        {
            children = null;
